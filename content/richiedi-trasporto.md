...
<form id="form-prenota" class="prenota-form" novalidate>
  ...
  <p class="pf-nota">Nessun dato viene salvato online: il modulo prepara solo un messaggio (email o WhatsApp) che invii tu dal tuo telefono. In alternativa, puoi chiamarci o scriverci su WhatsApp qui sotto.</p>
</form>
