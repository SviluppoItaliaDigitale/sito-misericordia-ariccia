...
italianoSemplice: |
  **Cosa fare in caso di emergenza.**
  ...
  Se una persona sta male, la prima cosa da fare è **chiamare il 112**. È gratis e risponde sempre.

  Poi resta vicino alla persona e segui le indicazioni dell'operatore al telefono.
...
<strong>In caso di emergenza chiama sempre il <a href="tel:112">112</a></strong> (Numero Unico di Emergenza). Le indicazioni di questa pagina sono un promemoria di base e <strong>non sostituiscono</strong> un corso di primo soccorso né l'intervento dei soccorritori. Segui sempre le istruzioni dell'operatore del 112.
</div>
...
<summary>Arresto cardiaco: la persona non risponde e non respira</summary>
...
<details class="faq-item">
<summary>Soffocamento (adulto o bambino che non respira/parla)</summary>
...
<details class="faq-item">
<summary>Svenimento o malore</summary>
...
<details class="faq-item">
<summary>Colpo di calore</summary>
